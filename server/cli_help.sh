...
private_SHOW_HELP_USERS () {
  MSG_INDENT_INC
    ...
    MESSAGE "user <username> get conf <var>            - get a variable value from the user configuration"
...
private_SHOW_HELP_TARGETS () {
  MSG_INDENT_INC
    ...
    MESSAGE "target <target-name> get conf <var>          - get a variable value from the target configuration file"
