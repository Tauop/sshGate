...
private_SHOW_HELP_USERS () {
  MSG_INDENT_INC
    ...
    MESSAGE "user <user> del conf <var>                         - delete a variable from the user configuration"
...
private_SHOW_HELP_TARGETS () {
  MSG_INDENT_INC
    ...
    MESSAGE "target <target> del conf <var>                  - delete a variable from the target configuration file"
